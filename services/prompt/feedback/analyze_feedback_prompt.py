...
[응답 규칙]
- JSON 내부의 모든 자연어 설명(`mismatch_reason`, `strengths.description`, `improvements.description` 등)은 **한국어 해요체(예: ~합니다 → ~해요, ~입니다 → ~이에요/예요)**로 작성하십시오.
...
- 응답을 상세하게 제공하십시오
 ...
 [출력 제한]
- 과도한 창의적 표현을 금지하고, 동일 입력에는 최대한 동일한 구조로 작성하십시오.
"""
